...
class preloadGame extends Phaser.Scene{
    ...
    preload(){
        this.load.image("platform", "flat1.png");
        this.load.image("frame", "sonic_frame.png");
        this.load.image("bg", "bg.png");

        // player is a sprite sheet made by 24x48 pixels
        this.load.spritesheet("player", "sonic.png", {
            frameWidth: 37,
            frameHeight: 45
        });
        ...
        this.load.spritesheet("mountain", "palm.png", {
            frameWidth: 361,
            frameHeight: 640
        });
    }
...
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        // adding the player;
        this.player = this.physics.add.sprite(gameOptions.playerStartPosition, game.config.height * 0.4, "player").setScale(1.25);
    ...
    addMountains(){
        ...
        if(rightmostMountain < game.config.width * 2){
            let mountain = this.physics.add.sprite(rightmostMountain + Phaser.Math.Between(100, 350), game.config.height + Phaser.Math.Between(0, 100), "mountain").setScale(0.75);
